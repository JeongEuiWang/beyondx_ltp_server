...
def insert_cargo_package() -> None:
    cargo_package_table = sa.table(
           ...
           sa.column('id', sa.Integer),
           sa.column('name', sa.String),
           sa.column('width', sa.Numeric(16, 4),),
    ...
    op.bulk_insert(
        cargo_package_table,
        [
            {"id": 1, "name": 'Pallet(48" * 40")', "width": 48, "length": 40, "height": None},
            {"id": 2, "name": 'Pallet(48" * 48")', "width": 48, "length": 48, "height": None},
            {"id": 3, "name": 'Pallet(60" * 48")', "width": 60, "length": 48, "height": None},
            ...
            {"id": 7, "name": 'Wooden Crate', "width": None, "length": None, "height": None},
        ]
    )
