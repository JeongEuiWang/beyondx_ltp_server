...
class RateService:
    def __init__(self, rate_location_repository: RateLocationRepository):
        self.rate_location_repository = rate_location_repository
    ...
    async def get_rate_locations(
        ...
        locations = await self.rate_location_repository.get_rate_location_by_query(
